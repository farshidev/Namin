...
let firstline = document.querySelector('.firstsentence');
let secondsentence = document.querySelector('.secondsentence');
window.onscroll = () => {
    let pos = window.scrollY - 800;

    firstline.style.left = `${pos}px`; 
    secondsentence.style.right = `${pos}px`; 
}
